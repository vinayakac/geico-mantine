...
/**
 * Component name: MLlogoSVG
 * Description : renders a Geico ML logo in SVG format that is customizable in size and color
 */

interface MLlogoSVGProps {
  width?: string;
  height?: string;
}

const MLlogoSVG = ({ width = '55px', height = '45px' }: MLlogoSVGProps) => (
  <div
    style={{
